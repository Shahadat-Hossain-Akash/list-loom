                        ...
                        users
                            ? <div>
                                <div className={styles.logged}>
                                    <div className={styles.profile}><p>{user.user?.name.substring(0, 2)}</p></div> <button aria-label='logout' onClick={() => signOut()}><Image src={'/assets/logout.svg'} alt='' width={35} height={35} /> </button>
                                </div>
